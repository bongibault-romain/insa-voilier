...
int main (void)
{
	...
	GPIO_Set_Config(GPIOA, 0, OUTPUT_2MHZ, O_ALTERNATE_GPO_PUSH_PULL);
	GPIO_Set_Config(GPIOA, 1, OUTPUT_2MHZ, O_ALTERNATE_GPO_PUSH_PULL);
	GPIO_Set_Config(GPIOA, 2, OUTPUT_2MHZ, O_ALTERNATE_GPO_PUSH_PULL);
	GPIO_Set_Config(GPIOA, 3, OUTPUT_2MHZ, O_ALTERNATE_GPO_PUSH_PULL);
	
	// CC2E & PW MODE 1
	Timer_PWM_Enable(TIM2, TIM_CHANNEL_1, PWM_MODE_2);
	Timer_PWM_Enable(TIM2, TIM_CHANNEL_2, PWM_MODE_2);
	Timer_PWM_Enable(TIM2, TIM_CHANNEL_3, PWM_MODE_2);
	Timer_PWM_Enable(TIM2, TIM_CHANNEL_4, PWM_MODE_2);
	
	Timer_PWM_Set(TIM2, TIM_CHANNEL_1, 0xFFFF/2);	
	Timer_PWM_Set(TIM2, TIM_CHANNEL_2, 0xFFFF/3);	
	Timer_PWM_Set(TIM2, TIM_CHANNEL_3, 0xFFFF/4);	
	Timer_PWM_Set(TIM2, TIM_CHANNEL_4, 0xFFFF/5);	
